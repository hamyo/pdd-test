...
public class ChooseTestHandler implements MessageHandler {
    ...
    public void handle(@NonNull Update update) {
        ...
        InlineKeyboardMarkup markup = new InlineKeyboardMarkup(
                ...
                .map(availableTest -> new InlineKeyboardRow(
                        ...
                        .callbackData(PersonCommand.NEW_TEST.getAction() + "[" + availableTest.getId() + "]")
                        .build())
                ).toList());
    ...
    public boolean canHandle(Update update) {
        return ((update.hasMessage() &&
                ...
                StringUtils.equalsIgnoreCase(update.getMessage().getText(), PersonCommand.CHOOSE_TEST.getAction())) ||
                (update.hasCallbackQuery() &&
                        StringUtils.equalsIgnoreCase(update.getCallbackQuery().getData(), PersonCommand.CHOOSE_TEST.getAction()))) &&
